...
?>
		...
		<?php }	
			...
			$totalsfinal = 0;
			$receiving_quantity = intval($item['receiving_quantity']);
			$totaldiscount = $cost*$quantity*$discount;
			// $totaldiscount = $cost*$quantity*$discount*$receiving_quantity;
			...
			?>
			<!-- <td><?php echo substr($name,0,6); ?></td> -->
		 	<!-- <td><?php echo substr($name,0,6);// }?></td> -->
			...
			<!-- <td><?php //echo to_currency(round(intval(($item['price'])*intval($item['quantity'])*intval($item['receiving_quantity'])-$item['price']*$item['quantity']*$item['discount']*$item['receiving_quantity']/100+$new_value),0)); ?></td>			 		 -->
			<td><?php echo to_currency($totalsfinal); ?></td>			 		
			<!-- <td><?php //echo to_currency(round($totalcost-($totaldiscount/100)+$new_value),0)); ?></td>			 		 -->
