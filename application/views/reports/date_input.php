...
$(document).ready(function()
{
	$("#generate_report").click(function()
	{
		...
		{
			window.location = window.location+'/'+$("#report_date_range_simple option:selected").val()+ '/' + $('#specific_input_data').val() + '/' + input_type
			+ '/' + export_excel;
		}
		else
		{
			...
			window.location = window.location+'/'+start_date + '/'+ end_date + '/' + $('#specific_input_data').val() + '/' + input_type + '/'+ export_excel;
		}
	});
