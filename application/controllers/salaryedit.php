...
class Salaryedit extends Secure_area implements iData_controller
{
	...
	function index($limit_from=0)
	{
		...
		$data['manage_table'] = get_salary_manage_table($giftcards, $this);
		$this->load->view('salaries/salarymanage', $data);
	}
