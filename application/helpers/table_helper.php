...
/*
Gets the html table to manage assets
*/
function get_assets_manage_table( $assets, $controller )
{
	...
	'Asset Name','Asset Category','Depreciation Rate','Purchase Price','Resale Price','Date of Purchase','Depreciation','Current Value','Added By',
	'&nbsp', '&nbsp');
...
function get_assets_manage_table_data_rows($assets, $controller)
{
	...
	foreach($assets->result() as $value)
	{
		$table_data_rows .= get_asset_data_row($value, $controller);
	}
...
function get_asset_data_row($value, $controller)
{
	...
	$table_data_row.='<td>'.$serial_no.'</td>';
	$table_data_row.='<td>'.$name.'</td>';
	$table_data_row.='<td>'.$category.'</td>';
	$table_data_row.='<td>'.$depreciation_rate.'</td>';
	$table_data_row.='<td>'.to_currency($price).'</td>';
	$table_data_row.='<td>'.to_currency($resale_price).'</td>';
	$table_data_row.='<td>'.date('F d Y',strtotime($date_of_purchase)).'</td>';
	$table_data_row.='<td>'.to_currency($depreciation).'</td>';
	$table_data_row.='<td>'.to_currency($current_value).'</td>';
